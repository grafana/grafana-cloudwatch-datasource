...
export function XrayLinkConfig({ newFormStyling, datasourceUid, onChange }: Props) {
  ...
  return newFormStyling ? (
    <ConfigSection
      ...
      description="Grafana will automatically create a link to a trace in Application Signals (formerly X-ray) data source if logs contain @xrayTraceId field"
    >
      {!hasXrayDatasource && (
        <Alert
          title={
    ...
    <>
      ...
      <div className={styles.infoText}>
        Grafana will automatically create a link to a trace in Application Signals (formerly X-ray) data source if logs
        contain @xrayTraceId field
      </div>
